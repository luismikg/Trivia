...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context,
                "${args?.numCorrect}, NumQuestions: ${args?.numQuestions}",
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        //Checar si va a ser posible llamar a una actividad que comparta nuestros resultados
        if (null == getSharedIntend().resolveActivity(activity!!.packageManager)){
    ...
    private fun getSharedIntend(): Intent {
        ...
        return shareIntent
        */
        //Otra forma de hacerlo de una forma mas moderna
